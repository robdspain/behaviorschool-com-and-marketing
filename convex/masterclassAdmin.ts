...
export const importEnrollment = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const payload = {
      ...
      certificateGeneratedAt: args.certificateGeneratedAt,
      certificateEmailed: args.certificateEmailed,
      certificateEmailedAt: args.certificateEmailedAt,
      ipAddress: args.ipAddress,
      userAgent: args.userAgent,
      referralSource: args.referralSource,
      feedbackSubmitted: args.feedbackSubmitted,
