  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom Behavior School palette
        indigo: {
          50: "#eef2ff",
          100: "#e0e7ff",
          200: "#c7d2fe",
      ...
      boxShadow: {
        feature: '0 4px 6px -1px rgba(0, 102, 0, 0.1), 0 2px 4px -1px rgba(0, 102, 0, 0.06)',
        'feature-hover': '0 10px 15px -3px rgba(0, 102, 0, 0.2), 0 4px 6px -2px rgba(0, 102, 0, 0.1)'
      },
      backgroundImage: {
        'hero-pattern': 'none',
