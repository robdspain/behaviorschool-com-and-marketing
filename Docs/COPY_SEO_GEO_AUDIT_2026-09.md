...
6. ~~Founding date.~~ Incorrect. Delaware Certificate of Formation for Behavior School LLC was filed April 1, 2024 (file 3358113). State entity search screenshot matches. IRS EIN notice is later (July 15, 2024). No 2020 formation document in the Drive LLC folder. JSON-LD `foundingDate` updated to `2024-04-01`.
