...
CREATE TABLE IF NOT EXISTS email_templates (
  ...
  body_text TEXT,
  body_html TEXT,
  category VARCHAR(100) DEFAULT 'signup',
...
INSERT INTO email_templates (name, description, subject, body_text, body_html, category, send_delay_minutes)
VALUES (
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; padding: 40px 20px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        <tr><td style="padding: 40px 40px 20px; text-align: center; border-bottom: 3px solid #10b981;"><h1 style="margin: 0; font-size: 24px; color: #0f172a; font-weight: 700;">Behavior School</h1></td></tr>
        <tr><td style="padding: 40px;">
          ...
          <div style="background-color: #f0fdf4; border-left: 4px solid #10b981; padding: 16px; margin: 24px 0;"><p style="margin: 0; font-size: 16px; color: #166534; font-weight: 600;">🎯 NEXT STEP: Schedule your consultation call</p></div>
          ...
          <ul style="margin: 0 0 20px; padding-left: 20px; color: #334155;"><li style="margin-bottom: 8px;">We''ll discuss your specific challenges and goals</li><li style="margin-bottom: 8px;">You''ll see exactly how the system can help you</li><li style="margin-bottom: 8px;">Get all your questions answered (no pressure!)</li></ul>
        ...
        <tr><td style="padding: 0 40px 40px;"><div style="border-top: 1px solid #e2e8f0; padding-top: 24px;"><p style="margin: 0 0 8px; font-size: 16px; color: #0f172a; font-weight: 600;">Looking forward to connecting,</p><p style="margin: 0 0 4px; font-size: 16px; color: #0f172a; font-weight: 600;">Rob Spain</p><p style="margin: 0; font-size: 14px; color: #64748b;">Creator, School BCBA Transformation System<br>Behavior School</p></div></td></tr>
        <tr><td style="padding: 20px 40px; background-color: #f8fafc; border-top: 1px solid #e2e8f0; border-radius: 0 0 8px 8px;"><p style="margin: 0; font-size: 12px; color: #94a3b8; text-align: center;">Behavior School | Empowering BCBAs in Schools</p></td></tr>
      </table>
    </td></tr>
  </table>
</body>
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        ...
        <tr><td style="padding: 40px;">
          ...
          <ul style="margin: 0 0 24px; padding-left: 20px; color: #334155;"><li style="margin-bottom: 8px; font-size: 16px;">Understand your specific challenges and goals</li><li style="margin-bottom: 8px; font-size: 16px;">Show you exactly how the system can transform your practice</li><li style="margin-bottom: 8px; font-size: 16px;">Answer any questions you have about the program</li></ul>
          <table width="100%" cellpadding="0" cellspacing="0" style="margin: 32px 0;"><tr><td align="center"><a href="https://calendly.com/robspain/behavior-school-transformation-system-phone-call" style="display: inline-block; padding: 16px 32px; background-color: #10b981; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">📅 Book Your Call Now</a></td></tr></table>
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        ...
        <tr><td style="padding: 40px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin: 32px 0;"><tr><td align="center"><a href="https://calendly.com/robspain/behavior-school-transformation-system-phone-call" style="display: inline-block; padding: 16px 32px; background-color: #10b981; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">📅 Book Your 15-Minute Call</a></td></tr></table>
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        ...
        <tr><td style="padding: 40px;">
          ...
          <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 16px; margin: 24px 0;"><p style="margin: 0; font-size: 14px; color: #92400e;"><strong>P.S.</strong> Sarah told me the biggest game-changer was the "5-Minute FBA Framework." It''s one of 12 systems you''ll get access to. Want to hear more about it? Book your call above.</p></div>
        </td></tr>
        <tr><td style="padding: 0 40px 40px;"><div style="border-top: 1px solid #e2e8f0; padding-top: 24px;"><p style="margin: 0 0 4px; font-size: 16px; color: #0f172a; font-weight: 600;">Rob Spain</p><p style="margin: 0; font-size: 14px; color: #64748b;">Creator, School BCBA Transformation System</p></div></td></tr>
        <tr><td style="padding: 20px 40px; background-color: #f8fafc; border-top: 1px solid #e2e8f0; border-radius: 0 0 8px 8px;"><p style="margin: 0; font-size: 12px; color: #94a3b8; text-align: center;">Behavior School | Empowering BCBAs in Schools</p></td></tr>
      </table>
    </td></tr>
  </table>
...
-- Verify setup
SELECT name, category, send_delay_minutes, is_active FROM email_templates ORDER BY send_delay_minutes;

COMMENT ON TABLE email_templates IS 'Stores all email templates for the signup sequence and other campaigns';
