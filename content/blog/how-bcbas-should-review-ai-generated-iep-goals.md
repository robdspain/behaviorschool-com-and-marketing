...
author: Rob Spain
featured_image: "/profile-Rob.webp"
tags:
  - AI
  - IEP Goals
  - BCBA
...
For the larger strategy, see [AI IEP Goals for Behavior Analysts](/blog/ai-iep-goals-for-behavior-analysts) and the [AI for behavior analysts](/ai-for-behavior-analysts) hub.
...
This is where the [FBA to BIP](/fba-to-bip) connection matters. Assessment, intervention, and IEP goals should tell the same story.
...
Read the full guide to [AI IEP goals for behavior analysts](/blog/ai-iep-goals-for-behavior-analysts), explore [AI for behavior analysts](/ai-for-behavior-analysts), or use the [IEP Goal Writer](/iep-goal-writer) to draft behavior goals with a more behavior-analytic frame.
