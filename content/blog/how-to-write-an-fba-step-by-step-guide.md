...
Use structured interview tools like the Functional Assessment Interview (FAI) or the Questions About Behavioral Function (QABF). Key questions include:
...
**Student Interview**
Don't skip this. Students — especially older ones — often have insight into their own behavior. Ask open-ended questions:
...
Parents provide critical information about setting events, sleep patterns, medication, and behavior at home. They also help you understand cultural context that should inform your intervention.
...
For a complete guide on building function-based BIPs, check out our guide on [function-based behavior intervention plans](/blog/function-based-behavior-intervention-plans).
...
*Want more guides like this delivered to your inbox? [Subscribe to the BehaviorSchool newsletter](/subscribe) for weekly tips on school-based ABA practice, BCBA exam prep, and evidence-based behavior support.*
