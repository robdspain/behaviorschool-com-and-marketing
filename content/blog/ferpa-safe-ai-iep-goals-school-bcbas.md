...
For the broader strategy, see [AI for behavior analysts](/ai-for-behavior-analysts). For goal writing support, see the [IEP Goal Writer](/iep-goal-writer).
...
For a full checklist, see [How BCBAs Should Review AI-Generated IEP Goals](/blog/how-bcbas-should-review-ai-generated-iep-goals).
...
You can explore the main AI hub at [AI for behavior analysts](/ai-for-behavior-analysts), draft behavior goals with the [IEP Goal Writer](/iep-goal-writer), or review examples in our [IEP behavior goals guide](/blog/iep-behavior-goals-complete-guide-with-examples).
