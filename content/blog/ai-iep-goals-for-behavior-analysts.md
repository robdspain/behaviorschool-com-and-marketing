...
author: Rob Spain
featured_image: "/Hero/Hero-group1-optimized.webp"
tags:
  - AI
  - IEP Goals
  - Behavior Analysts
...
If you want the broader framework, start with our [AI for behavior analysts](/ai-for-behavior-analysts) hub. If you need a tool built specifically around school behavior goals, try the [IEP Goal Writer](/iep-goal-writer).
...
For more on that assessment-to-plan link, see our [FBA to BIP workflow](/fba-to-bip).
...
2. Review FBA and present-level data.
3. Identify the likely function.
4. Select the replacement behavior.
5. Use AI to draft goal options.
6. Review for observability, measurement, and function alignment.
7. Revise with the IEP team.
8. Finalize the goal and data collection plan.
...
You can explore the broader AI framework at [AI for behavior analysts](/ai-for-behavior-analysts), write goals with the [IEP Goal Writer](/iep-goal-writer), or review examples in our [IEP behavior goals guide](/blog/iep-behavior-goals-complete-guide-with-examples).
