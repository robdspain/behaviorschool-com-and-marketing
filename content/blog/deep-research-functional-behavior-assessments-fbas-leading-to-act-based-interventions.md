...
Such qualitative feedback, combined with objective data, shows that integrating ACT does not just theoretically make sense but is feasible and valued in practice.
Conclusion
Research at the nexus of FBA and ACT demonstrates that comprehensive behavior intervention planning can benefit from understanding both external and internal controlling variables.
...
Andrews, M. L., Garcia, Y. A., Catagnus, R. M., & Gould, E. R. (2021). Effects of acceptance and commitment training plus behavior parent training on parental implementation of autism treatment. *The Psychological Record, 72*, 149–163. [DOI](https://doi.org/10.1007/s40732-021-00496-5)
...
Friman, P. C., Hayes, S. C., & Wilson, K. G. (1998). Why behavior analysts should study emotion: The example of anxiety. *Journal of Applied Behavior Analysis, 31*(1), 137–156. [DOI](https://doi.org/10.1901/jaba.1998.31-137)
...
Hahs, A. D., Dixon, M. R., & Paliliunas, D. (2019). Randomized controlled trial of a brief acceptance and commitment training for parents of individuals diagnosed with autism spectrum disorders. *Journal of Contextual Behavioral Science, 12*, 154–159. [DOI](https://doi.org/10.1016/j.jcbs.2018.03.002)

Heath, H., & Smith, R. G. (2019). Precursor behavior and functional analysis: A brief review. *Journal of Applied Behavior Analysis, 52*(3), 804–810. [DOI](https://doi.org/10.1002/jaba.571)

Hoffmann, A. N., Contreras, B. P., Clay, C. J., & Twohig, M. P. (2016). Acceptance and commitment therapy for individuals with disabilities: A behavior analytic strategy for addressing private events in challenging behavior. *Behavior Analysis in Practice, 9*(3), 243–253. [DOI](https://doi.org/10.1007/s40617-016-0105-4)

<!-- UNVERIFIED CITATION: Haydon, T. (2023). Insights into Learning Disabilities, 20(2), 81–99 – Could not verify this citation in any database. The journal and article could not be found. -->

<!-- UNVERIFIED CITATION: Maji, S. et al. (2022). Behavior Analysis in Practice – Could not find a paper by "Maji" on relational training and ACT. The description matches Gilsenan et al. (2021), DOI: 10.1007/s40617-021-00574-8 -->

<!-- UNVERIFIED CITATION: Singh, N. N. et al. (2019) – described as "ACT decreased verbal and physical aggression in three adolescents with ASD" but could not find this specific paper. Singh (2019) published on MBPBS, not ACT for aggression in adolescents. -->
...
Snyder, K., Lambert, J., & Twohig, M. P. (2011). Defusion: A behavior-analytic strategy for addressing private events. *Behavior Analysis in Practice, 4*(2), 4–13. [DOI](https://doi.org/10.1007/BF03391779)
