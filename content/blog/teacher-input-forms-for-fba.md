---
title: "Teacher Input Forms for FBA: How to Get Useful Data from Classroom Staff"
excerpt: "Stop getting vague, unusable teacher input for FBAs. Use these interview templates and strategies to collect meaningful, function-focused data from classroom staff in less time."
...
tags:
  ...
  - blog
status: published
meta_title: "Teacher Input Forms for FBA: Get Useful Data Fast"
meta_description: "Practical FBA interview templates and strategies to get meaningful, function-focused data from teachers. Includes free downloadable forms."
---
...
>
> "On a scale of 1-5, how disruptive is this behavior to the student's learning?"
> (1 = minimal, 5 = completely prevents learning)
>
> "On a scale of 1-5, how disruptive is this behavior to other students' learning?"
> (1 = minimal, 5 = completely halts instruction)
...
>
> | Strategy | Helped | No Effect | Made It Worse | Haven't Tried |
> |----------|--------|-----------|---------------|---------------|
> | Verbal reminders or redirection | ☐ | ☐ | ☐ | ☐ |
> | Breaks or movement breaks | ☐ | ☐ | ☐ | ☐ |
> | Preferred seating or location | ☐ | ☐ | ☐ | ☐ |
> | Visual schedule or checklist | ☐ | ☐ | ☐ | ☐ |
> | Reward chart or token system | ☐ | ☐ | ☐ | ☐ |
> | Extra time or modified assignments | ☐ | ☐ | ☐ | ☐ |
> | Peer buddy or partner | ☐ | ☐ | ☐ | ☐ |
> | Ignoring the behavior | ☐ | ☐ | ☐ | ☐ |
> | Consequences (loss of privileges, etc.) | ☐ | ☐ | ☐ | ☐ |
>
> "What motivates this student? (Activities, items, people, praise, etc.)"
...
1. **What are the most common antecedents?** (This tells you when to observe.)
2. **What consistently follows the behavior?** (This points to maintaining consequences.)
3. **What does the teacher think the function is?** (They are often right, even if they do not use ABA language.)
4. **What interventions made it worse?** (These likely reinforced the behavior.)
...
---
Thank you! Your input is essential to developing an effective behavior plan.
```
