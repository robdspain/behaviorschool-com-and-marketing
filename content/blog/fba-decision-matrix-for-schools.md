---
title: "FBA Decision Matrix: When Does a Student Need a Functional Behavior Assessment?"
excerpt: "A practical decision matrix to help school teams determine when a student needs a full FBA versus simpler behavior interventions. Save time, resources, and ensure the right level of support."
...
tags:
  ...
  - blog
status: published
meta_title: "FBA Decision Matrix: When Does a Student Need an FBA?"
meta_description: "Decision matrix for school teams: When does a student need a full FBA vs simpler interventions? Clear criteria, examples, and workflow."
---
...
- [Tier 2 Behavior Support Plan](/blog/tier-2-behavior-support-plan-template) with clear strategies
...
If your team decides a student needs a full FBA, [BehaviorSchool Pro](https://plan.behaviorschool.com) is the FBA-to-BIP workspace for school BCBAs. Early access is on a waitlist.
...
*Need an FBA-to-BIP workspace? [Join the BehaviorSchool Pro waitlist](https://plan.behaviorschool.com) for early access.*
