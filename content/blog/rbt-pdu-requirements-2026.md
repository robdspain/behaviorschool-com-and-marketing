---
title: "RBT PDU Requirements 2026: Everything School RBTs Need to Know"
excerpt: "New for 2026: RBTs must complete 12 PDUs every 2 years. Learn what counts, what does not, how BCBAs can deliver in-service PDUs, and how to track compliance."
...
tags:
  ...
  - blog
status: published
meta_title: "RBT PDU Requirements 2026: 12 Hours Every 2 Years"
meta_description: "2026 RBT PDU requirements explained. What counts, what does not, and how school BCBAs can provide PDUs. Start tracking now."
---
...
1. **Ethics in school-based ABA** (1 hour)
2. **Data collection and fidelity checks** (1 hour)
3. **FBA basics and hypothesis statements** (1 hour)
4. **Function-based reinforcement strategies** (1 hour)
5. **Crisis prevention and de-escalation** (1 hour)
6. **ABA and trauma-informed practices** (1 hour)
7. **Functional communication training** (1 hour)
8. **IEP behavior goals and progress monitoring** (1 hour)
9. **School-wide PBIS strategies** (1 hour)
10. **RBT role boundaries and ethical decision-making** (1 hour)
11. **ACT-informed behavior support** (1 hour)
12. **End-of-cycle review and competency check** (1 hour)
...
**Solution:** Use a shared tracker or a platform like [learning.behaviorschool.com](https://learning.behaviorschool.com) which includes built-in certificates and tracking for PDUs.
...
*Need PDUs that actually fit school settings? [Explore BehaviorSchool PDU courses](https://learning.behaviorschool.com) and make compliance simple for your RBT team.*
