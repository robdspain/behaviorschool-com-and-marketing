---
title: "ACT-Based Behavior Support Plans: Bringing Acceptance and Commitment to Schools"
excerpt: "Combine traditional behavior plans with ACT and RFT to build flexible, values-based behavior support plans for students and staff in school settings."
...
tags:
  ...
  - blog
status: published
meta_title: "ACT-Based Behavior Support Plans for Schools"
meta_description: "Build ACT-based behavior support plans for schools. Practical steps, hexaflex in school context, and tools to blend ACT with BIPs."
---
...
*Want ACT tools built for school teams? [Explore BehaviorSchool ACT Tools](/act-tools) and add values-based strategies to your behavior plans without extra paperwork.*
