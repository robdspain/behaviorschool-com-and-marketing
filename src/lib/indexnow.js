...
exports.PRIORITY_URLS = void 0;
exports.submitToIndexNow = submitToIndexNow;
exports.submitUrlToIndexNow = submitUrlToIndexNow;
exports.submitBatchToIndexNow = submitBatchToIndexNow;
exports.submitPriorityUrls = submitPriorityUrls;
exports.submitBlogPost = submitBlogPost;
exports.submitLandingPageUpdate = submitLandingPageUpdate;
...
async function submitPriorityUrls() {
    return submitBatchToIndexNow(exports.PRIORITY_URLS);
}
/**
 * Auto-submit when blog posts are created/updated
 */
async function submitBlogPost(slug) {
    const urls = [
        `/blog/${slug}`,
 ...
 */
async function submitLandingPageUpdate(path) {
    const urls = [
        path,
