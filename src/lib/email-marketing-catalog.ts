...
export const behaviorStudyToolsSequence: EmailSequenceStep[] = [
  {
    ...
    audience: 'New free user with no diagnostic or practice history',
    objective: 'Complete the nine-domain check and identify one priority domain.',
  },
  {
    timing: 'Second study day',
    title: 'Use the result',
    subject: 'Your next 5 questions: {priority domain}',
    audience: 'Diagnostic completed, second study day not yet established',
  ...
  },
  {
    ...
    audience: 'Completed 20+ questions or a mock exam and still on the free plan',
  ...
  },
  {
    ...
    audience: 'Diagnostic or practice history followed by seven inactive days',
