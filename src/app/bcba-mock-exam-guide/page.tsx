          ...
          <section id="resources" className="mb-12">
            ...
            <div className="mb-6 rounded-xl border border-emerald-200 bg-white p-6">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <Link href="https://study.behaviorschool.com/free-mock-exam/" className="rounded-lg border border-slate-200 p-4 transition-colors hover:border-emerald-300 hover:bg-emerald-50">
                ...
                <Link href="https://study.behaviorschool.com/free-practice/" className="rounded-lg border border-slate-200 p-4 transition-colors hover:border-emerald-300 hover:bg-emerald-50">
