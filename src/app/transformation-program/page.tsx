...
export default function TransformationProgramPage() {
  ...
  return (
    <div className="min-h-screen bg-white relative pt-0">
      ...
      {/* Enroll */}
      <section id="enroll" className="py-20 sm:py-28 bg-[#dde8e3] text-[#1a1a1a] scroll-mt-24">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <details className="text-left bg-white/70 rounded-xl border border-[#1f4d3f]/15 overflow-hidden">
            ...
            <div className="px-6 pb-6 border-t border-[#1f4d3f]/10 pt-4 space-y-4">
              ...
              <div className="bg-[#1f4d3f]/5 rounded-lg border border-[#1f4d3f]/10 p-4">
