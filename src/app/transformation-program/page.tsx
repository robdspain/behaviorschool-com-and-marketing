      ...
      <section id="enroll" className="py-24 bg-slate-50 scroll-mt-24">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="block w-full rounded-2xl bg-[#1f4d3f] hover:bg-[#123628] text-white font-black text-xl py-5 px-8 text-center transition shadow-xl mb-3"
          >
            Reserve Your Spot — {FULL_PAY_PRICE}
          </a>

          {isEarlyBird && (
            <p className="text-sm font-semibold text-amber-700 mb-6">
              Early bird pricing ends March 21 — saves you $498
            </p>
          )}

          <p className="text-slate-500 text-sm mb-2">
            Prefer to pay monthly?{' '}
            <a href={INSTALLMENT_LINK} target="_blank" rel="noopener noreferrer" className="text-[#1f4d3f] font-semibold underline underline-offset-2">
          ...
          <p className="text-slate-400 text-xs mb-12">
            ...
            <a href={CALENDLY_LINK} target="_blank" rel="noopener noreferrer" className="text-[#1f4d3f] font-semibold underline underline-offset-2">
              Book a 15-minute call
            </a>
          </p>

          <details className="text-left bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="px-6 pb-6 border-t border-slate-100 pt-4 space-y-4">
              <p className="text-sm text-slate-600 leading-relaxed">
                Many BCBAs have their district cover this as professional development. Here&apos;s everything you need:
              </p>
              <a
                href="/transformation-program-pd-packet.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 p-3 rounded-xl border border-slate-200 hover:border-[#1f4d3f] transition text-sm font-semibold text-[#1f4d3f]"
              >
              ...
              <p className="text-xs text-slate-500">
                ...
                <a href="mailto:rob@behaviorschool.com?subject=District%20Enrollment%20%E2%80%94%20Transformation%20Program" className="text-[#1f4d3f] font-semibold underline underline-offset-2">
              ...
              <div className="bg-slate-50 rounded-xl border border-slate-200 p-4">
                ...
                <div className="bg-white border border-slate-200 rounded-lg p-4 text-xs text-slate-700 leading-relaxed font-mono whitespace-pre-line select-all">{`Subject: PD Approval Request — School BCBA Transformation Program

I'd like to attend a 6-week PD cohort for school-based BCBAs led by Rob Spain, BCBA (25 years in school settings, CalABA presenter).

This program addresses three problems directly:
1. FBA/BIP quality — builds a replicable, legally defensible process I can apply across my caseload.
2. RBT performance — structured supervision that reduces re-intervention time and improves consistency.
3. Staff retention — sustainable systems prevent the burnout that leads to BCBA turnover ($40–60K to replace).
