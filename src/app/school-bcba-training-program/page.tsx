        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-20">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link
                href={`/transformation-program?utm_source=school_bcba_training_program&utm_medium=landing_page&utm_campaign=${TRANSFORMATION_PROGRAM.cohort.id}`}
            ...
            <div className="mt-6 flex flex-wrap gap-3 text-sm font-semibold text-slate-700">
              {[TRANSFORMATION_PROGRAM.cohort.startBadge, "6 live sessions", "Small cohorts", `${TRANSFORMATION_PROGRAM.pricing.payInFull} tuition`].map((item) => (
