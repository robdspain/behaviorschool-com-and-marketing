    ...
    <>
      <header className="container header" role="banner">
        ...
        <nav className="nav" aria-label="Primary">
          <a href="/classroompilot">ClassroomPilot</a>
          <a href="/behaviorpilot">BehaviorPilot</a>
          <a href="/tierpath">TierPath</a>
        </nav>
      </header>
      ...
      <main>
        ...
        <section className="container section" id="waitlist">
          ...
          <form name="waitlist" method="POST" data-netlify="true" netlify-honeypot="bot-field" className="form">
      ...
      <footer className="container footer" role="contentinfo">
        <div>© BehaviorPilot · A Behavior School product</div>
        <div className="small">Questions? <a href="mailto:hello@behaviorschool.com">hello@behaviorschool.com</a></div>
      </footer>
