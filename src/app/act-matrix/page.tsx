...
export const metadata: Metadata = {
  ...
  description: "FREE ACT Matrix PDF download with examples & implementation guide for school behavior analysts. Proven values-based framework for professional practice.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
