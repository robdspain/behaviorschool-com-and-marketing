...
function toSubmissionRow(submission: any) {
  return {
    ...
    employer: submission.employer ?? null,
    role_category: submission.roleCategory ?? null,
    payment_path: submission.paymentPath ?? null,
    urgency_window: submission.urgencyWindow ?? null,
