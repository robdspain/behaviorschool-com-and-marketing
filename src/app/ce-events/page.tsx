...
export const metadata: Metadata = {
  ...
  description: 'Browse and register for professional development events. BCBAs & BCaBAs earn CEUs (Continuing Education Units) · RBTs earn PDUs (Professional Development Units).',
  openGraph: {
