    ...
    <main className="bg-white min-h-screen">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12 sm:py-16" style={{ fontFamily: "'Georgia', serif" }}>
        ...
        <section className="mb-10">
          ...
          <p className="text-base leading-relaxed text-slate-700 mb-4">
            However, a growing body of behavior-analytic literature suggests that this model encounters consistent limitations when applied to students whose behavior is primarily mediated by private verbal events -  specifically, rigid rules, evaluative self-narratives, and experiential avoidance (Dixon, Hayes, &amp; Belisle, 2023; Törneke, Luciano, &amp; Valdivia Salas, 2008). For these students, the observable antecedent captured in ABC data is not the functional antecedent. Rather, the functional antecedent is the <em>thought</em> triggered by the environment: an automatically derived verbal relation such as "if I am redirected, then I am stupid" or "if I attempt the task, then I will fail." Standard consequence manipulation does not disrupt these internal contingencies, and BIPs targeting only the external environment frequently fail to produce durable behavior change (Dixon et al., 2018).
          </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-2 text-sm text-slate-600 leading-relaxed">
            ...
            <p>Belisle, J., &amp; Dixon, M. R. (2020). Relational density theory. <em>Perspectives on Behavior Science, 43</em>(2), 283–303.</p>
            <p>Cooper, J. O., Heron, T. E., &amp; Heward, W. L. (2020). <em>Applied behavior analysis</em> (3rd ed.). Pearson.</p>
            <p>Dixon, M. R., Hayes, S. C., &amp; Belisle, J. (2023). Acceptance and commitment training in behavior analysis. <em>Behavior Analysis in Practice, 16</em>(1), 178–193.</p>
