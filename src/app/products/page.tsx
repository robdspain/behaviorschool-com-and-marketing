  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="mx-auto max-w-6xl px-6 lg:px-8 py-16">
        ...
        >
          {/* BehaviorPilot card */}
          <Link href="/products/behaviorpilot" className="group rounded-2xl">
            <motion.div
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-blue-400 text-white shadow-md group-hover:scale-105 transition-transform">BP</span>
                <h2 className="text-2xl font-semibold text-slate-900">BehaviorPilot</h2>
              </div>
              <p className="mt-3 text-slate-600">AI-powered BCBA platform for FBAs, BIPs, and school-based data tracking. Create, collect, and report with speed and fidelity.</p>
