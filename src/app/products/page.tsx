            ...
            >
              <div className="p-6 sm:p-8">
                <div className="flex items-center gap-3">
                  <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-sky-500 to-cyan-400 text-white shadow-md group-hover:scale-105 transition-transform">BP</span>
                  <h2 className="text-2xl font-semibold text-slate-900">BehaviorPilot</h2>
                </div>
                <p className="mt-3 text-slate-600">BCBA software for FBAs, BIPs, and school-based data collection.</p>
