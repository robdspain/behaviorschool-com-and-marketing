...
import { Bolt, BarChart3, ShieldCheck, Clock, Layers, BookOpen, FileText, Target, Activity } from "lucide-react";
      ...
      <section className="mx-auto max-w-6xl px-6 lg:px-8 py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-slate-600 mt-4 max-w-3xl mx-auto">
            Comprehensive software solutions for school-based behavior management, special education, and multi-tiered support systems.
          </p>
        </div>
        ...
        >
          {/* BehaviorPilot card */}
          <Link href="/behaviorpilot" className="group rounded-2xl">
            <motion.div
              className="rounded-2xl bg-white/80 ring-1 ring-slate-200/70 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.25)] transition-all duration-300 h-full"
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                <span className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-400 text-white shadow-md group-hover:scale-105 transition-transform">
                  <FileText className="h-6 w-6" />
                </span>
                <h2 className="text-2xl font-semibold text-slate-900">BehaviorPilot</h2>
              </div>
              <p className="text-slate-600 mb-4">BCBA Software for FBAs, BIPs & Data Collection</p>
              <p className="text-sm text-slate-500 mb-6">All-in-one platform for school-based BCBAs to create functional behavior assessments, build intervention plans, and track progress with AI-powered tools.</p>
              <div className="inline-flex items-center rounded-lg bg-emerald-600 px-4 py-2 text-white group-hover:bg-emerald-700 transition-colors">
                Learn more
          ...
          {/* ClassroomPilot card */}
          <Link href="/classroompilot" className="group rounded-2xl">
            <motion.div
              className="rounded-2xl bg-white/80 ring-1 ring-slate-200/70 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.25)] transition-all duration-300 h-full"
              variants={{ hidden: { opacity: 0, y: 24 }, show: { opacity: 1, y: 0 } }}
              whileHover={{ y: -8, scale: 1.02 }}
            ...
            >
              <div className="p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-4">
                <span className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-yellow-500 to-amber-400 text-white shadow-md group-hover:scale-105 transition-transform">
                  <Target className="h-6 w-6" />
                </span>
                <h2 className="text-2xl font-semibold text-slate-900">ClassroomPilot</h2>
              </div>
              <p className="text-slate-600 mb-4">IEP Goal Tracking & Progress Monitoring</p>
              <p className="text-sm text-slate-500 mb-6">Special education software for teachers to plan IEP-aligned lessons, track student progress, document accommodations, and generate compliant reports.</p>
              <div className="inline-flex items-center rounded-lg bg-yellow-600 px-4 py-2 text-white group-hover:bg-yellow-700 transition-colors">
                Learn more
                <svg className="ml-2 h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path d="M10.293 15.707a1 1 0 010-1.414L13.586 11H5a1 1 0 110-2h8.586l-3.293-3.293a1 1 0 111.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z"/></svg>
              </div>
              </div>
          ...
          {/* TierPath card */}
          <Link href="/tierpath" className="group rounded-2xl">
            <motion.div
              className="rounded-2xl bg-white/80 ring-1 ring-slate-200/70 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.25)] transition-all duration-300 h-full"
              variants={{ hidden: { opacity: 0, y: 24 }, show: { opacity: 1, y: 0 } }}
              whileHover={{ y: -8, scale: 1.02 }}
            ...
            >
              <div className="p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-4">
                <span className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-indigo-400 text-white shadow-md group-hover:scale-105 transition-transform">
                  <Layers className="h-6 w-6" />
                </span>
                <h2 className="text-2xl font-semibold text-slate-900">TierPath</h2>
              </div>
              <p className="text-slate-600 mb-4">MTSS & PBIS Software for Districts</p>
              <p className="text-sm text-slate-500 mb-6">Connect teams, track MTSS tiers, manage PBIS interventions, and monitor progress from universal screening to Tier 3 fidelity in one system.</p>
              <div className="inline-flex items-center rounded-lg bg-blue-600 px-4 py-2 text-white group-hover:bg-blue-700 transition-colors">
                Learn more
                <svg className="ml-2 h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path d="M10.293 15.707a1 1 0 010-1.414L13.586 11H5a1 1 0 110-2h8.586l-3.293-3.293a1 1 0 111.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z"/></svg>
              </div>
              </div>
        ...
        <div className="mt-16 pt-16 border-t border-slate-200">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 text-center mb-10">Additional Resources</h2>
          <motion.div
