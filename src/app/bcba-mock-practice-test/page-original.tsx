        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "BCBA Resources", "item": "https://study.behaviorschool.com/free-practice/" },
              { "@type": "ListItem", "position": 3, "name": "BCBA Mock Practice Test", "item": "https://study.behaviorschool.com/free-mock-exam/" }
            ]
          })
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-20">
          <div className="bg-white rounded-3xl shadow-lg border border-slate-200 p-8 lg:p-12">
            ...
            <p className="text-slate-700 mt-6">Start free at <a href="https://study.behaviorschool.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 underline font-medium">study.behaviorschool.com</a>.</p>
          </div>
        </section>
