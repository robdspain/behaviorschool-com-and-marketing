  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch("/api/subscribe", {
        ...
        body: JSON.stringify({ email: state.email, name: state.name, company: "" }),
      });
  ...
  return (
    <section className="w-full max-w-screen-md px-2 mx-auto py-10">
      ...
      <div
        ...
        style={{ backgroundImage: "radial-gradient(164.75% 100% at 50% 0,#272f3c 0,#0b1224 48.73%)" }}
      >
        ...
        <div>
          <h3 className="mb-10 text-2xl font-semibold text-slate-300">Connect with Us</h3>
          <div className="mb-12 flex gap-8">
            <Link className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-600 shadow-inner shadow-gray-800 hover:shadow-md hover:shadow-slate-500 hover:transition hover:duration-300 hover:ease-in-out" href="#">
          ...
          <div className="mb-12 flex gap-8">
            <Link className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-600 px-2 shadow-inner shadow-gray-800 hover:shadow-md hover:shadow-slate-500 hover:transition hover:duration-300 hover:ease-in-out" href="#">
          ...
          <div className="flex space-x-12 py-7">
            <Link className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-600 bg-gray-800 hover:shadow-md hover:shadow-slate-500 hover:transition hover:duration-300 hover:ease-in-out" href="https://x.com/behavior_school" target="_blank" rel="noopener noreferrer">
              <Twitter className="h-5 w-5 text-white" />
            </Link>
            <Link className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-600 bg-gray-800 hover:shadow-md hover:shadow-slate-500 hover:transition hover:duration-300 hover:ease-in-out" href="https://www.facebook.com/profile.php?id=61564836345571" target="_blank" rel="noopener noreferrer">
              <Facebook className="h-5 w-5 text-white" />
            </Link>
            <Link className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-700 bg-gray-800 hover:shadow-md hover:shadow-slate-500 hover:transition hover:duration-300 hover:ease-in-out" href="https://www.instagram.com/behaviorschool" target="_blank" rel="noopener noreferrer">
              <Instagram className="h-5 w-5 text-white" />
            </Link>
            <Link className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-700 bg-gray-800 hover:shadow-md hover:shadow-slate-500 hover:transition hover:duration-300 hover:ease-in-out" href="https://github.com/robdspain" target="_blank" rel="noopener noreferrer">
      ...
      {state.submitted && (
        <p className="text-center text-sm text-emerald-700">Thanks! We&apos;ll be in touch.</p>
      )}
    </section>
  );
}
