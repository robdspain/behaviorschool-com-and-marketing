...
export const DEMO_WIZARD_DATA: ACTFBAData = {
  profile: {
    studentName: "Maya R.",
    studentAge: "9",
    studentGrade: "4th",
    ...
    assessor: "Behavior Support Team",
    teamMembers: "BCBA, Gen Ed Teacher, Caregiver",
  },
  interviewResponses: {
    "values-1": "She wants to feel proud of her work and stay with her class.",
    "values-3": "Being a good friend and finishing tasks feels important to her.",
    "obstacles-1": "She shuts down when assignments feel too long or confusing.",
    "obstacles-3": "Worries about being wrong or looking silly.",
    "school-1": "Writing time and independent seatwork transitions.",
    "action-1": "Use a help card and ask for a break instead of refusing.",
  },
  thoughtMediatedBehaviors: "Avoids writing tasks, says “I can’t,” puts head down, or tears paper.",
  interviewValuesCandidates: "Belonging, growth, helping others",
  initialMatrixDraft: {
    innerAway: ["I’m going to mess this up", "Feeling embarrassed"],
    innerToward: ["Wanting to feel proud", "Wanting to stay with peers"],
    outerAway: ["Rips worksheet", "Leaves seat"],
    outerToward: ["Uses help card", "Starts first problem"],
  },
  actMatrix: {
    innerAway: ["I’m going to mess this up", "Feeling embarrassed"],
    innerToward: ["Wanting to feel proud", "Wanting to stay with peers"],
  ...
  selectedValues: ["belonging", "growth", "helping"],
  valuesRationale: "Top values emphasize staying connected to peers, improving skills, and helping others.",
  abcObservations: [
    {
      antecedent: "Independent writing task assigned",
      precursor: "Sighs, asks to go to nurse",
      behavior: "Refuses work, tears paper",
      consequence: "Removed from task and given a break",
      latencySeconds: 120,
    },
  ],
  validatingLatencyAvg: "60",
  challengingLatencyAvg: "180",
  validatingConditionNotes: "Short, scaffolded task with visual choices.",
  challengingConditionNotes: "Longer writing task with minimal prompts.",
  fusionHierarchy: "1) 1-sentence response 2) 3 sentences 3) full paragraph",
  studentCpfqResponses: { "s-acc-1": 2, "s-def-2": 3 },
  caregiverCpfqResponses: { "c-acc-1": 2 },
  verbalRelations: [
    {
      statement: "I’m bad at writing",
      category: "self-deictic",
      impact: "Avoids work when writing starts",
      flexAlternative: "I’m still learning to write, and I can ask for help",
    },
  ],
  aimAcceptPlan: "Teach grounding and breathing for 60 seconds before starting work.",
  aimIdentifyPlan: "Label unhelpful thoughts and restate them as “my mind says…”.",
  aimMovePlan: "Use a help card, complete first item, then take a short break.",
  targetBehavior: "Task refusal during writing",
  operationalDefinition: "Student puts head down, tears worksheet, or refuses to write within 2 minutes of task presentation.",
  hypothesizedFunction: "Escape/avoidance",
  privateEventFunction: "Avoiding embarrassment and thoughts of being wrong.",
  replacementBehaviors: "Request help, start first item, use break card appropriately.",
  selectedStrategies: [
    { category: "acceptance", strategy: "Willingness Scale", implementation: "Rate discomfort 1–10 and continue for 2 minutes." },
    { category: "defusion", strategy: "My Mind Says", implementation: "Prompt: “My mind says I can’t.”" },
    { category: "values-action", strategy: "Small Steps", implementation: "Complete first two items, then earn a break." },
  ],
  implementationMaterials: {
    bstChecklist: true,
    visualGuides: true,
    dataTemplates: true,
    caregiverHandout: true,
    implementationNotes: "Coach staff on help-card prompt and track latency weekly.",
  },
  decisionRules: "If refusal occurs more than 2x/day for 2 consecutive weeks, adjust antecedent supports.",
  progressMetrics: "Latency to start task, number of refusals, CPFQ pre/post scores.",
  reviewCadence: "Weekly for 6 weeks, then biweekly.",
};
