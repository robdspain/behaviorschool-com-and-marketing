...
const QUICK_DOMAIN_CHECK_HREF = "https://study.behaviorschool.com/free-practice/";
    ...
    <div className="fixed bottom-4 inset-x-0 z-40 flex justify-center px-4">
      <div className="max-w-3xl w-full bg-white/90 backdrop-blur rounded-2xl shadow-lg border border-slate-200 p-3 flex items-center justify-between gap-3">
        <div className="text-sm text-slate-700">
          Ready? Try a free Quick domain check (9 questions) with instant scoring.
        </div>
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            href={QUICK_DOMAIN_CHECK_HREF}
            target="_blank"
            rel="noopener noreferrer"
          >
            Start Quick domain check <ArrowRight className="ml-1 h-4 w-4" />
          </a>
        </div>
      </div>
    </div>
