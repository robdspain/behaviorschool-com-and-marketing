...
export function RevenueBanner() {
  ...
  return (
    <div className="hidden md:flex bg-emerald-900 text-white py-2.5 px-4 text-center text-sm font-semibold shadow-md">
      <div className="max-w-7xl mx-auto flex items-center justify-center gap-3">
        <span className="text-white">CalABA 2026 is coming. Join the founding member offer and the Transformation Program waitlist.</span>
        <Link
          href="/calaba-2026"
        ...
        >
          Transformation Program Waitlist
        </Link>
        <button
