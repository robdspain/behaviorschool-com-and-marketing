  ...
  return (
    <div className="mt-8 space-y-3">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 flex items-center justify-between">
        ...
        <Link href="https://app.behaviorschool.com/signup" className="text-xs font-bold text-amber-700 hover:text-amber-900 underline">
          Get Unlimited
        </Link>
      </div>
      ...
      <div className="bg-gradient-to-r from-emerald-700 to-emerald-600 rounded-xl px-6 py-5 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          {showSave && (
            <Link href="https://app.behaviorschool.com">
