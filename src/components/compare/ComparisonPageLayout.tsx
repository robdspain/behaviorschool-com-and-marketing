      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-slate-600 text-lg leading-relaxed">
            <strong>BehaviorSchool</strong> is an all-in-one platform built for school BCBAs and behavior analysts in education. It combines exam prep, IEP goal writing tools, behavior plan generators, and professional development — all designed by a practicing school BCBA with 25+ years of experience.
          </p>
        </div>
      </section>
