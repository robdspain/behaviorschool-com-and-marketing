      ...
      {menuSections.map((section) => {
        ...
        if (hasChildren) {
          return (
            ...
            >
              <motion.button
                className="inline-flex items-center gap-1 px-4 py-2 text-lg font-medium text-white focus:outline-none relative rounded-lg"
                aria-haspopup="menu"
        ...
        return (
          ...
          >
            <Link
              href={section.href ?? "#"}
              className="px-4 py-2 text-lg font-medium text-white relative block rounded-lg"
